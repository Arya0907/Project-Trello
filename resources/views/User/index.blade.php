...
@endif 
    <div class="container mt-5">
        <div class="card shadow-sm">
            ...
            <form class="d-flex" action="{{route('user.homeuser')}}" role="search" method="GET">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('user.edit', $user['id']) }}" class="btn btn-sm btn-outline-info me-2"><i class="fas fa-edit"></i> Edit</a>
